export const RESOURCE_DEFS = {
  ...
  users: {
    ...
    fields: [
      ...
      ["adminWorkgroupId", "Admin Space ID", "text"],
    ],
  },
  roles: {
    title: "Roles",
  ...
  categories: {
    ...
    fields: [
      ["name", "Name", "text"],
      ["description", "Description", "textarea"],
      ["creator", "Owner Person ID", "user-combobox"],
    ],
  },
  items: {
    title: "Items",
    ...
    supportsWorkgroupScope: true,
    fields: [
      ["workgroupId", "Space ID", "text"],
      ["name", "Name", "text"],
      ["description", "Description", "textarea"],
      ["url", "URL", "text"],
      ["location", "Location", "text"],
      ["categoryId", "Category ID", "text"],
      ["imageId", "Picture ID", "text"],
    ],
  },
  images: {
    title: "Pictures",
  ...
  votes: {
    ...
    fields: [
      ...
      ["itemId", "Item ID", "text"],
      ["userId", "Person ID", "user-combobox"],
